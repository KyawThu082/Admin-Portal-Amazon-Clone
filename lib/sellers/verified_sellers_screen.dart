            ...
            return Card(
              ...
              child: Column(
                children: [
                  ...
                  //       .get("photoUrl"), // Check the field name
                  //   errorBuilder: (context, error, stackTrace) {
                  //     print("Error loading image: $error");
                  //     print("Stack trace: $stackTrace");
                  //     return const Icon(Icons
                  //         .error); // Show an error icon if image loading fails
                  //   },
                  // ),
                  Text(
                      ...
                      GestureDetector(
                        onTap: () {
                          showReusableSnackbar(context,
                              "${"Total Earning = ".toUpperCase()}${allApprovedSellers!.docs[index].get("earnings")} Kyat");
                        },
                        child: Padding(
                          padding:
                              const EdgeInsets.only(top: 18.0, bottom: 8.0),
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${allApprovedSellers!.docs[index].get("earnings")} Kyat",
                                style: const TextStyle(
                                  color: Colors.amber,
                                ),
                              ),
